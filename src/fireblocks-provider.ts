...
export class FireblocksProvider extends Provider {
    constructor(private readonly fallbackProvider: Provider) {
        super();
    }
    call(
        ...
        return this.fallbackProvider.call(transaction, blockTag);
    }
    ...
    estimateGas(transaction: Deferrable<TransactionRequest>): Promise<BigNumber> {
        return this.fallbackProvider.estimateGas(transaction);
    }
